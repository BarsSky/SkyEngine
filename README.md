...
- [X] Реализация линии по буферу вершин, круг и прямоугольник — частные случаи
- [X] Подгружаемые ресурсы для примеров
...
- [ ] Ввести адаптивную генерацию объектов и сложных поверхностей  
  - [ ] Расширить функционал формирования объекта с помощью heghtMap
---
