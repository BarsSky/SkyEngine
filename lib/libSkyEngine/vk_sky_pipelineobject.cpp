...
void *pipelineObject::create_UI_Form() {
  return object = reinterpret_cast<void*>(new UIForm());
}

void *pipelineObject::create_Text_Form() {
  return object = reinterpret_cast<void*>(new TextForm());
}

void * pipelineObject::create_Shape_Form() {
  return object = reinterpret_cast<void*>(new ShapeForm());
}