...
namespace initializers
{
    ...
    inline VkWriteDescriptorSet createVkWriteDescriptorTexture(uint32_t binding, VkDescriptorImageInfo *imageInfo, VkDescriptorSet descriptorSet)
    {
    ...
    inline VkWriteDescriptorSet createVkWriteDescriptorBuffer(uint32_t binding, VkDescriptorBufferInfo *bufferInfo, VkDescriptorSet descriptorSet)
    {
        VkWriteDescriptorSet descriptor{};
        descriptor.sType = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
        descriptor.dstSet = descriptorSet;
