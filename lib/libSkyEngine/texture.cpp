...
namespace vks
{
    ...
    */
    void Texture2D::loadFromFile(std::string filename, VkFormat format, VulkanDevice *device, VkQueue copyQueue, VkImageUsageFlags imageUsageFlags, VkImageLayout imageLayout, bool forceLinear)
    {
        ...
        // Get device physicalDeviceProperties for the requested texture format
        ...
        samplerCreateInfo.maxAnisotropy = device->enabledFeatures.samplerAnisotropy ? device->physicalDeviceProperties.limits.maxSamplerAnisotropy : 1.0f;
