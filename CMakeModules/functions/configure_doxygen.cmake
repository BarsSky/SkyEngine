...
if(DOXYGEN_FOUND)
	...
	add_custom_target(doc_${PROJECT_NAME}
					  ...
					  COMMENT "Generating documentation of ${PROJECT_NAME} using doxygen"
					  VERBATIM
					  )
	...
	install(DIRECTORY
			${DOC_PATH}
			DESTINATION ${${PROJECT_NAME}_INSTALL_PREFIX}${CMAKE_INSTALL_DATAROOTDIR}/${PROJECT_NAME}/${CMAKE_INSTALL_DOCDIR}
			COMPONENT docs)
else()
